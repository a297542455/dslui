  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        ...
        tenantId: [
          { required: true, trigger: 'change', validator: validateTenantId }
        ]
      },
      loading: false,
            ...
            .then(() => {
              ...
              this.$store.dispatch('user/setMenu').then(() => {
                ...
                if (selectPath !== pathname) {
                  // 当前pathname变化了，需要改变location
                  location.pathname = selectPath
                }
